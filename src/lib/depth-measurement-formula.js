export function formula(
	...
	const crossLineSpacing = mainLineSpacing * 10;
	...
	const numberOfCrossLines = Math.ceil(areaWidth / crossLineSpacing) + 1;
	...
	const totalActiveSurveyTime = totalDistance / 1000 / (vesselSpeed * 1.852);
